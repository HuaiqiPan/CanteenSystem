...
{
    public partial class BanzuOrderListForm : Form
    {
       
        UserBusinessLogic usersBusinessLogic = new UserBusinessLogic();
        Users user = new Users();
        public BanzuOrderListForm(string userID)
        {
        ...
        public void loadOrderList()
        {
            ...
            List<Order> orderlist = orderBusinessLogic.GetOrderByStatusAndCreator("未发送",user.RealName);
